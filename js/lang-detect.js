/* ============================================================
   Ferrari 499P 自动语言检测 — 每次加载页面都检查访问者 IP
...
(function () {
  ...
  var saved = null;
  try { saved = localStorage.getItem('f499p-lang'); } catch (e) {}

  // 语言按钮点击:事件委托记录用户显式选择(必须在提前 return 之前注册,
  ...
  document.addEventListener('click', function (ev) {
    ...
    try { localStorage.setItem('f499p-lang', lang); } catch (e) {}
  });
